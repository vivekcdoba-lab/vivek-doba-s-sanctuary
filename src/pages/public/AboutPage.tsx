...
export default function AboutPage() {
  return <>
    ...
    <section className="max-w-6xl mx-auto px-4 py-14 sm:py-20 grid md:grid-cols-[320px_1fr] gap-10 items-center">
      <img src={vivekDobaPhoto} alt="Vivek Doba" className="w-full max-w-xs mx-auto aspect-square object-cover rounded-lg border-4 border-primary/20 shadow-xl" />
