...
export default function BlogPage() {
  ...
  return <main className="bg-background"><PublicSeo title="Blog | Business, Health & Family Balance | Vivek Doba" description="Practical articles for business owners on growth, leadership, mindset, health and family, rooted in Indian wisdom." path="/blog" schemas={[breadcrumbSchema([{ name: 'Home', path: '/' }, { name: 'Blog', path: '/blog' }])]} />
