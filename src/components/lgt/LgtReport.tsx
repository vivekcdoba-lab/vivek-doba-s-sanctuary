    ...
    <div id="lgt-report-print" className="space-y-5 bg-background p-4 sm:p-6 print:bg-white" style={{ color: '#1f2937' }}>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <div className="text-xs uppercase tracking-widest opacity-90">Vivek Doba Business Mastery</div>
      ...
      <div className="text-center text-xs text-muted-foreground pt-2">
        Generated by VDBM · vivekdoba.com · This report is confidential and meant for the seeker and Vivek Sir only.
      </div>
    </div>
  );
};
