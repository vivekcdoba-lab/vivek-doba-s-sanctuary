          ...
          {!collapsed && (
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-1 mt-1">
                <Flame className="w-3 h-3 text-[hsl(var(--saffron))]" />
                      ...
                      <TooltipTrigger asChild>
                        <Link
                          ...
                          className={`flex items-center justify-center p-2 rounded-lg transition-all ${
                            isActive(item.path)
                              ? 'bg-[hsl(var(--saffron))]/15 text-[hsl(var(--saffron))] border-l-[3px] border-[hsl(var(--saffron))]'
                      ...
                      {group.items.map(item => (
                        <Link
                          ...
                          className={`flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-sm transition-all ${
                            isActive(item.path)
                              ? 'bg-[hsl(var(--saffron))]/15 text-[hsl(var(--saffron))] border-l-[3px] border-[hsl(var(--saffron))] font-medium'
