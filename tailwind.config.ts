  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "chakra-indigo": "hsl(var(--chakra-indigo))",
        "dharma-green": "hsl(var(--dharma-green))",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 6px 2px hsl(27 100% 60% / 0.3)" },
          "50%": { boxShadow: "0 0 16px 6px hsl(27 100% 60% / 0.6)" },
        },
        "confetti-fall": {
      ...
      animation: {
        ...
        "sidebar-slide-in": "sidebar-slide-in 0.3s ease-out forwards",
      },
    },
  },
